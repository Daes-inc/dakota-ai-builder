...
function slugify(text) {
  return String(text || "starter app")
    .toLowerCase()
    .replace(/[^a-z0-9]+/g, "-")
    .replace(/^-|-$/g, "") || "starter-app";
}
...
- \`_redirects\` — static redirects support
...
1. Download the ZIP.
2. Unzip it.
3. Import the folder/repo into Vercel.

### Cloudflare Pages
1. Download the ZIP.
2. Unzip it.
3. Upload the files to Cloudflare Pages.
...
<body>
  <div class="card">
    ...
    <p>Turn a prompt into a deploy-ready starter app and download it as a ZIP.</p>
